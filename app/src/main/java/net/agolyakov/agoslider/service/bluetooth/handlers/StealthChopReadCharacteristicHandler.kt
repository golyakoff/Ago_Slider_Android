...
class StealthChopReadCharacteristicHandler(
    private val stealthChopFlow: MutableStateFlow<Triple<Boolean, Boolean, Boolean>>
    ...
    override fun onReadCharacteristicCallback(device: BluetoothDevice, data: Data) {
        ...
        stealthChopFlow.value = Triple(xEn, cEn, bEn)
    }
}